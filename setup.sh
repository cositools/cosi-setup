...
confhelp() {
  ...
  echo "    --root=[path]      Use the version of ROOT found in the path. If it is not compatible, the script will stop with an error."
  echo " "
  ...
  echo " "
  echo "--heasoft=[options: off (default), empty, cfitsio, path to existing HEASoft installation]"
