...
confhelp() {
  ...
  echo "    The (currently) supported ROOT versions are stored in the file \"allowed-versions.txt\". The format is major.minor, e.g. 6.28."
  ...
  echo "    The (currently) supported GEANT4 versions are stored in the file \"allowed-versions.txt\". The format is major.minor, e.g. 11.2."
